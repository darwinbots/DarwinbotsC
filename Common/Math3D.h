...
public:
	Vector4 (void) {}
	Vector4 (SCALAR a, SCALAR b, SCALAR c=0, SCALAR d = 1)
	...
	const SCALAR &x(void) const { return X; }
	const SCALAR &y(void) const { return Y; }
	const SCALAR &z(void) const { return Z; }
	const SCALAR &w(void) const { return W; }
...
public:
	...
	inline const SCALAR* operator[] (int i) const { return &e[i<<2]; }
	inline SCALAR* operator() (int i) { return &e[i<<2]; }
...
inline Vector4 operator- (const Vector4 &v1, const Vector4 &v2)
{
  ...
  inline Vector4 VectorSub2D(const Vector4 &v1, const Vector4 &v2)
{
    return Vector4(v1.x()-v2.x(),
                   v1.y()-v2.y());
}
